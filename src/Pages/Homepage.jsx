...
import { IconUser, IconBriefcase2Filled } from '@tabler/icons-react';
        ...
        <nav className="hidden md:flex gap-8 text-gray-700 font-medium">
          ...
          <div className="relative group">
            ...
            <div className="absolute hidden group-hover:flex flex-col bg-white shadow-lg mt-2 rounded-md w-48 text-sm text-gray-700">
              <Link to="/jobs" className="px-4 py-2 hover:bg-gray-100">Browse Jobs</Link>
              <Link to="/saved" className="px-4 py-2 hover:bg-gray-100">Saved Jobs</Link>
